            ...
            <div class="container text-center header-content">
                ...
                <p>
                    ...
                    if(get_theme_mod( 'header_banner_tagline_setting' )){
                        ...
                        echo esc_html__('With a dedicated healthcare software development team, we help you build HIPAA-compliant custom healthcare software (mobile and web applications).','wp-bootstrap-starter');
                    }
                    ?>
                </p>
